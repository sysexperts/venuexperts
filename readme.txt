...
* **FEATURE:** Optionaler Title-Parameter für Archive-Shortcode
* **FIX:** Pagination-Zentrierung verbessert (width: 100%, align-items)
...
* **INFO:** SVG-Datei bleibt im Projekt für spätere Verwendung erhalten

= 1.24.2 =
* **FIX:** Schwanen-Wasserzeichen jetzt sichtbar - doppelte Opacity entfernt
* **FIX:** Wasserzeichen auf 0.08 Opacity erhöht (vorher quasi unsichtbar)
* **FIX:** Wasserzeichen jetzt auch auf Countdown und Week-Preview Widgets
...
* **FEATURE:** Neuer Shortcode `[kh_week_preview]` - Wochenübersicht im Timeline-Design
* **DESIGN:** Event-Countdown als Hero-Widget mit Hintergrundbild und animiertem Timer
* **DESIGN:** Wochenübersicht zeigt alle Events Mo-So in kompaktem Grid-Layout
* **UX:** Live-Countdown aktualisiert sich jede Sekunde automatisch
* **UX:** Heutiger Tag wird in Wochenübersicht hervorgehoben
...
* **DESIGN:** Moderne, cleane UI basierend auf aktuellen Best Practices (2024-2026)
* **DESIGN:** Tailwind-inspirierte Farbpalette und Spacing-System
* **DESIGN:** Klare visuelle Hierarchie, optimierte Typografie und Geometrie
* **DESIGN:** Verbesserte Input-States (Focus, Hover) mit subtilen Schatten
* **UX:** Komplett überarbeitete Filter-Komponenten (Search, Selects, Reset, Counter)

= 1.22.6 =
* **DESIGN:** `[kh_event_program]` Filterbar komplett neu aufgebaut (neues visuelles System)
* **DESIGN:** Suchfeld vollständig neu gestaltet (modernes UI mit integrierter Search-Icon-Führung)
* **DESIGN:** Selects + Reset vollständig neu ausbalanciert (dezent, kompakt, klar)
* **UX:** Bewegte Animationen/Transitions im Program-Widget konsequent entfernt

= 1.22.5 =
* **DESIGN:** `[kh_event_program]` Filterleiste vollständig neu ausbalanciert (modern, reduziert, klarere Feldhierarchie)
* **DESIGN:** Suchfeld neu gestaltet (integriertes Such-Icon, ruhiger Input-Look, bessere Lesbarkeit)
* **DESIGN:** Dropdowns neu gestaltet (kompaktere Geometrie, moderne Pfeile, klarere visuelle States)
* **DESIGN:** Reset-Button deutlich entschärft (klein, dezent, nicht mehr dominant)
* **UX:** Bewegte Effekte/Animationen im Program-Widget entfernt

= 1.22.4 =
* **DESIGN:** Suchfeld im `[kh_event_program]` modernisiert (ruhigere Flächen, Such-Icon im Feld, bessere Lesbarkeit)
* **DESIGN:** Dropdowns überarbeitet (moderne Pfeile, klarere States, kompaktere Geometrie)
* **DESIGN:** Reset-Button nochmals entschärft (kleiner, unaufdringlicher, weniger dominant)
